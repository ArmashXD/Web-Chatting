			...
			<div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
				<div class="row">
					...
					<?php
						...
						$total_messages = "select * from users_chat where (sender_username='". $user_name ."' AND receiver_username='". $user_name ."') OR (receiver_username='$user_name' AND sender_username='$username')"; 
